...
from dcrnn.model.pytorch.dcrnn_model import DCRNNModel
from dcrnn.model.pytorch.loss import masked_mae_loss
...
class DCRNNSupervisor:
    def __init__(self, adj_mx, **kwargs):
        ...
        #print(self._data.get('x_train').shape)
    ...
    def _train(self, base_lr,
        ...
        epochs = self._train_kwargs.get('epochs', 0)
    ...
    def predict(self,X):
        return self.dcrnn_model(X).to(device="cpu")
